...
# example:
#OpenOCD_DIR="C:/Ac6/SystemWorkbench/plugins/fr.ac6.mcu.externaltools.openocd.win32_1.16.0.201708311556/tools/openocd/"
OpenOCD_DIR=""

# 2) Set the installation path for stm32 OpenOCD scritps
# example:
#OpenOCD_CFC="C:/Ac6/SystemWorkbench/plugins/fr.ac6.mcu.debug_2.1.2.201709081530/resources/openocd/scripts"
OpenOCD_CFC=""
...
echo "/******************************************/"
${OpenOCD_CMD} -c "init" -c "reset halt" -c "flash write_image erase  ./STM32L4xx-Nucleo/Debug_IKS01A2/ALLMEMS1_IKS01A2_NucleoL476.bin 0x08004000 bin" -c "shutdown"
echo "/******************************************/"
echo "      Dump FP-SNS-ALLMEMS1 + BootLoader"
echo "/******************************************/"

SizeBinBL=`ls -l ./STM32F4xx-Nucleo/Debug_IKS01A2/ALLMEMS1_IKS01A2_NucleoL476.bin | awk '{print $6+0x4000};'`
${OpenOCD_CMD} -c "init" \
			   -c "reset halt" \
			   -c "dump_image ./STM32L4xx-Nucleo/Debug_IKS01A2/ALLMEMS1_IKS01A2_NucleoL476_BL.bin 0x08000000 ${SizeBinBL}" \
			   -c "shutdown"
