...
echo "/******************************************/"
${OpenOCD_CMD} -c "program  ./STM32F4xx-Nucleo/Debug_IKS01A1/ALLMEMS1_IKS01A1_NucleoF401.bin exit reset 0x08004000"
echo "/******************************************/"
echo "     Dump FP-SNS-ALLMEMS1 + BootLoader"
echo "/******************************************/"

SizeBinBL=`ls -l ./STM32F4xx-Nucleo/Debug_IKS01A1/ALLMEMS1_IKS01A1_NucleoF401.bin | awk '{print $6+0x4000};'`
${OpenOCD_CMD} -c "init" \
			   -c "reset halt" \
			   -c "sleep 100" \
			   -c "wait_halt 2" \
			   -c "dump_image ./STM32F4xx-Nucleo/Debug_IKS01A1/ALLMEMS1_IKS01A1_NucleoF401_BL.bin 0x08000000 ${SizeBinBL}" \
			   -c "reset halt" \
			   -c "shutdown"
